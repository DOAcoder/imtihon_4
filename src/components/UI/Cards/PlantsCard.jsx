...
const PlantsCard = ({ state: { image, title, price, disc } }) => {
  const [click, setClick] = useState(false);

  return (
    <div className=" min-w-[270px] min-h-[270px] ">
      <div className="box relative">
        <img className="mb-[20px]" src={image} alt="gul" />
        ...
        <div className=" absolute top-[210px] right-[80px] flex items-center gap-[45px]">
      ...
      <div className="card_body ">
        <h3 className="text-[18px] font-medium leading-[22px] mb-[8px] ">
          {title}
        </h3>
